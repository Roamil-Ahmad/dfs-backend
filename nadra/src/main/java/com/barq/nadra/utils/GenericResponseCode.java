...
public enum GenericResponseCode {
    ...
    NID_FRONT_NOT_FOUND("451", "NID Front Not Found"),
    NID_BACK_NOT_FOUND("452", "NID Back Not Found"),
    ...
    USER_IS_LOCKED("158","USER IS LOCKED FOR 2 HRS DUE TO 3 FAILED ATTEMPTS"),
