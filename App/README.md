...
> Core customer/mobile application APIs (accounts, transfers, reports).
...
| Property | Value |
|----------|-------|
| **Service** | Customer App API (`App`) |
| **Port** | `8002` |
| **Context-path** | `/app` |
| **Swagger UI** | http://localhost:8002/app/swagger-ui/index.html |
...
### 🔗 Dependencies
- **Calls →** ThirdParties (OTP, geocode, notifications), Google Auth, Card Management
...
docker compose logs -f App    # follow this service's logs
...
```
http://localhost:8002/app/swagger-ui/index.html
```
