...
import com.dfs.app.dto.QrDecodeResponse;
import com.dfs.app.dto.QrRequest;
import com.dfs.app.dto.QrResponse;
...
public class QrServiceImpl implements QrService {
    ...
    public HashMap<String, Object> generateQr(QrRequest qrRequest, BigDecimal userId, Request request) throws ParseException {
        TblAccount tblAccount = tblAccountRepo.findByAccountNoOrCnicAndAccountLevelCode(qrRequest.getMobileNumber(), Constants.EMPTY, qrRequest.getAccountLevelCode());
        if(tblAccount==null){
            throw new CustomDataNotFoundException(GenericResponseCode.ACCOUNT_NOT_FOUND.getResponseCode());
        }
