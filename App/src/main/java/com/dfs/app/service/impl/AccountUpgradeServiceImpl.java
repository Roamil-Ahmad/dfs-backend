...
public class AccountUpgradeServiceImpl implements AccountUpgradeService {
    ...
    @Override
    public HashMap<String, Object> upgradeToL2(UpdateAccountLevelRequest request,
                                               Request httpRequest,
                                               BigDecimal userId,
    ...
    private void validateInitialData(UpdateAccountLevelRequest request) {
        // Validate OTP
    ...
    private TblAccount validateAndGetAccount(UpdateAccountLevelRequest request) {
        ...
        TblAppUser appUser = tblAppUserRepo.findByAccountNo(request.getMobileNumber());
        if (appUser == null) {
...
//        TblDocument proofOfAddressDoc = tblDocumentRepo.findByAppUserIdDocTypeCodeAccountLevelCode(appUser.getAppUserId(), proofOfAddress, accountLevelCode);
//        if (proofOfAddressDoc == null) {
...
//        }
    ...
    private HashMap<String, Object> uploadDocuments(UpdateAccountLevelRequest request,
                                                    Request httpRequest,
        ...
        return documentService.uploadDocument(uploadRequest, httpRequest, userId);
    }

    private HashMap<String, Object> processAccountUpgrade(UpdateAccountLevelRequest request,
                                                          Request httpRequest,
                                                          BigDecimal userId,
                                                          String header,
    ...
    private HashMap<String, Object> sendNotificationAndGetResponse(TblAccount account,
                                                                   UpdateAccountLevelRequest request,
                                                                   Request httpRequest,
                                                                   String header,
    ...
    public String getSelfieImage(String mobileNumber) {
        TblAppUser tblAppUser = tblAppUserRepo.findByAccountNo(mobileNumber);
        if (tblAppUser == null) {
            throw new CustomDataNotFoundException(GenericResponseCode.USER_NOT_FOUND.getResponseCode());
        }
