...
public class JWTSecurity {
    ...
    public String createJWTWithClaims(String subject, Map<String, Object> claims, int time) {
        ...
        // Add issued at and expiration based on milliseconds
        long expMillis = nowMillis + time * 60L * 1000L;
    ...
    public String createJWTWithClaimsForDays(String subject, Map<String, Object> claims, int days) {
