...
```java
package com.dfs.<service>.config;   // <-- adjust package
...
- **Want a visual UI** (timeline of which service took how long)? Add `spring-cloud-sleuth-zipkin` and point it at a Zipkin server. Not required for log correlation.
