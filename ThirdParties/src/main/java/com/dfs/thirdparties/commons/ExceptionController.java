...
import com.dfs.thirdparties.util.ValidationException;
...
public class ExceptionController extends HelperClass {
    ...
    private ResponseEntity<HashMap<String, Object>> handleValidationException(Exception ex,String exceptionName){
            ...
            return getCustomizedResponseFormat(HttpStatus.OK, GenericResponseCode.VALIDATION_ERROR.getResponseCode(),ex.getMessage(),null);
    ...
    private ResponseEntity<HashMap<String, Object>> handleException(Exception ex, HttpStatus httpStatus,boolean isCustom,String exceptionName){
        if(!isCustom){
            return getCustomizedResponseFormat(HttpStatus.OK, GenericResponseCode.CUSTOM_MESSAGE.getResponseCode(),ex.toString(),null);

        }else {

            return getCustomizedResponseFormat(HttpStatus.OK,ex.getMessage(), commonService.getResponseMessageByCode(ex.getMessage()),null);
        }
