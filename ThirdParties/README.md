...
> Shared integrations: OTP, notifications, reverse-geocoding, Twilio SMS, SMTP.
...
| Property | Value |
|----------|-------|
| **Service** | Third Parties (`ThirdParties`) |
| **Port** | `8008` |
| **Context-path** | `/thirdparties` |
| **Swagger UI** | http://localhost:8008/thirdparties/swagger-ui/index.html |
...
### 🔗 Dependencies
- **Calls →** Twilio, SMTP (external)
- **Called by ←** AgentApp, App, Transactions
...
docker compose logs -f ThirdParties    # follow this service's logs
...
```
http://localhost:8008/thirdparties/swagger-ui/index.html
```
