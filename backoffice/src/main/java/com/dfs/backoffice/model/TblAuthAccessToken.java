...
public class TblAuthAccessToken implements Serializable {
    ...
    private BigDecimal appUserLoginHistoryId;
    ...
    private BigDecimal mwChannelId;
    ...
    public BigDecimal getMwChannelId() {
        return this.mwChannelId;
    }

    public void setMwChannelId(BigDecimal mwChannelId) {
    ...
    public BigDecimal getAppUserLoginHistoryId() {
        return appUserLoginHistoryId;
    }

    public void setAppUserLoginHistoryId(BigDecimal appUserLoginHistoryId) {
