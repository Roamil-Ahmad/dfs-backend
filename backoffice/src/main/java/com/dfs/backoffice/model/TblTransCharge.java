...
public class TblTransCharge implements Serializable {
	...
	private BigDecimal velocityCount;
	...
	@OneToMany(mappedBy="tblTransCharge")
	...
	public BigDecimal getVelocityCount() {
		return this.velocityCount;
	}

	public void setVelocityCount(BigDecimal velocityCount) {
	...
	public TblAgentClassCharge addTblAgentClassCharge(TblAgentClassCharge tblAgentClassCharge) {
		...
		tblAgentClassCharge.setTblTransCharge(this);
	...
	public TblAgentClassCharge removeTblAgentClassCharge(TblAgentClassCharge tblAgentClassCharge) {
		...
		tblAgentClassCharge.setTblTransCharge(null);
