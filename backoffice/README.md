...
> Administrative back-office APIs (operations, reporting).
...
| Property | Value |
|----------|-------|
| **Service** | Back Office (`BackOffice`) |
| **Port** | `8003` |
| **Context-path** | `/backoffice` |
| **Swagger UI** | http://localhost:8003/backoffice/swagger-ui/index.html |
...
### 🔗 Dependencies
- **Calls →** WorkFlow, Google Auth, Card Management
- **Called by ←** —
...
docker compose logs -f BackOffice    # follow this service's logs
...
```
http://localhost:8003/backoffice/swagger-ui/index.html
```
