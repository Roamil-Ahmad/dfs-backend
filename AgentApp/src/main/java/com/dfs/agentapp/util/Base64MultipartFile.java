...
public class Base64MultipartFile implements MultipartFile {
    ...
    public static MultipartFile fromBase64(String base64, String fileName, String contentType) {
        if (base64 == null || base64.trim().isEmpty()) {
            throw new CustomDataNotFoundException("Failed to convert Base64 string to MultipartFile: no content for file " + fileName);
        }
        try {
            ...
            throw new CustomDataNotFoundException("Failed to convert Base64 string to MultipartFile for file "
