...
public class RequestValidator {
    ...
    /**
     * Both values are mandatory: the CNIC is what stops the endpoint from returning an account
     * holder's name and date of birth to anyone who knows the account number.
     */
    public static void validateCashInInquiry(CashInInquiryRequest cashInInquiryRequest) {
        if (isNullOrEmpty(cashInInquiryRequest.getAccountNo())) {
            throw new ValidationException("Account No Required");
        }
        if (isNullOrEmpty(cashInInquiryRequest.getDepositorNid())) {
            throw new ValidationException("Depositor Nid Required");
        }
    }
    ...
    public static void validateNidRequest(AgentKycRequest nidRequest) {
        ...
        if (isNullOrEmpty(nidRequest.getNidNo())) {
            throw new ValidationException("INVALID NID NUMBER");
        }
    ...
    public static void validateNidBvsRequest(NidBvsRequest nidBvsRequest, Request request) {
        ...
        for (BvsRequest bvsRequest : nidBvsRequest.getBvsRequest()) {
            ...
            if (isNullOrEmpty(bvsRequest.getBase64Template())) {
                throw new ValidationException("Invalid Finger Template for index: " + fingerIndex);
            }
    ...
    public static void validateUpdateAccountLevelRequest(UpdateAccountLevelRequest updateAccountLevelRequest, Request request) {
        ...
        if (isNullOrEmpty(updateAccountLevelRequest.getProvinceCode())) {
            throw new ValidationException("INVALID PROVINCE CODE");
        }
    ...
    public static void validateUpdateAccountLevelRequest(CustomerUpdateAccountLevelRequest updateAccountLevelRequest, Request request) {
        if (isNullOrEmpty(updateAccountLevelRequest.getMobileNumber())) {
            throw new ValidationException("INVALID MOBILE NUMBER");
        }
    ...
    /** A device binding is meaningless without the handset identifier it binds to. */
    public static void validateRegisterDeviceRequest(RegisterDeviceRequest registerDeviceRequest) {
        if (isNullOrEmpty(registerDeviceRequest)) {
            throw new ValidationException("INVALID REQUEST");
        }
        if (isNullOrEmpty(registerDeviceRequest.getImeiNo())) {
            throw new ValidationException("INVALID IMEI NUMBER");
        }
    }
}
