...
public class TblAgent implements Serializable {
	...
	//bi-directional many-to-one association to TblAgentBusiness
	@OneToMany(mappedBy="tblAgent")
	private List<TblAgentBusiness> tblAgentBusinesses;
	...
	public List<TblAgentBusiness> getTblAgentBusinesses() {
		return this.tblAgentBusinesses;
	}

	public void setTblAgentBusinesses(List<TblAgentBusiness> tblAgentBusinesses) {
		this.tblAgentBusinesses = tblAgentBusinesses;
	}

	public TblAgentBusiness addTblAgentBusiness(TblAgentBusiness tblAgentBusiness) {
		getTblAgentBusinesses().add(tblAgentBusiness);
		tblAgentBusiness.setTblAgent(this);

		return tblAgentBusiness;
	}

	public TblAgentBusiness removeTblAgentBusiness(TblAgentBusiness tblAgentBusiness) {
		getTblAgentBusinesses().remove(tblAgentBusiness);
		tblAgentBusiness.setTblAgent(null);
