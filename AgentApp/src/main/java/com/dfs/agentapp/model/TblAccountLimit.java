...
/**
 * The persistent class for the TBL_ACCOUNT_LIMIT database table.
 * 
 */
@Entity
@Table(name="TBL_ACCOUNT_LIMIT")
@NamedQuery(name="TblAccountLimit.findAll", query="SELECT t FROM TblAccountLimit t")
public class TblAccountLimit implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="TBL_ACCOUNT_LIMIT_ACCOUNTLIMITID_GENERATOR", sequenceName="TBL_ACCOUNT_LIMIT_SEQ",allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="TBL_ACCOUNT_LIMIT_ACCOUNTLIMITID_GENERATOR")
	...
	public TblAccountLimit() {
	}

	public long getAccountLimitId() {
		return this.accountLimitId;
	}

	public void setAccountLimitId(long accountLimitId) {
