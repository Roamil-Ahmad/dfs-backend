...
> Agent-facing APIs for the DFS agent application.
...
| Property | Value |
|----------|-------|
| **Service** | Agent App (`AgentApp`) |
| **Port** | `8001` |
| **Context-path** | `/agentapp` |
| **Swagger UI** | http://localhost:8001/agentapp/swagger-ui/index.html |
...
### 🔗 Dependencies
- **Calls →** ThirdParties (OTP, geocode, notifications), WorkFlow
- **Called by ←** —
...
docker compose logs -f AgentApp    # follow this service's logs
...
```
http://localhost:8001/agentapp/swagger-ui/index.html
```
