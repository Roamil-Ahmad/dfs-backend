...
| Property | Value |
|----------|-------|
| **Service** | Push Notification (`pushnotification`) |
| **Port** | `8012` |
| **Context-path** | `/firbase` |
| **Swagger UI** | http://localhost:8012/firbase/swagger-ui/index.html |
| **Database** | None (stateless service) |
| **Packaging** | WAR (runs standalone via `java -jar` in Docker; deploys to external Tomcat in prod) |

### 🔗 Dependencies
- **Calls →** Firebase (external)
...
docker compose logs -f pushnotification    # follow this service's logs
...
```
http://localhost:8012/firbase/swagger-ui/index.html
```
