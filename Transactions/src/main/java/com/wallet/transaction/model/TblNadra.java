...
public class TblNadra implements Serializable {
	...
	@Id
	@SequenceGenerator(name="TBL_NADRA_CNIC_GENERATOR", sequenceName="TBL_NADRA_SEQ",allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="TBL_NADRA_CNIC_GENERATOR")
	private long cnic;
	...
	//bi-directional many-to-one association to TblNadraMismatch
	@OneToMany(mappedBy="tblNadra")
	private List<TblNadraMismatch> tblNadraMismatches;
	...
	public List<TblNadraMismatch> getTblNadraMismatches() {
		return this.tblNadraMismatches;
	}

	public void setTblNadraMismatches(List<TblNadraMismatch> tblNadraMismatches) {
		this.tblNadraMismatches = tblNadraMismatches;
	}

	public TblNadraMismatch addTblNadraMismatch(TblNadraMismatch tblNadraMismatch) {
		getTblNadraMismatches().add(tblNadraMismatch);
		tblNadraMismatch.setTblNadra(this);

		return tblNadraMismatch;
	}

	public TblNadraMismatch removeTblNadraMismatch(TblNadraMismatch tblNadraMismatch) {
		getTblNadraMismatches().remove(tblNadraMismatch);
		tblNadraMismatch.setTblNadra(null);
