...
public class WalletToCardIssuerRequest {
    ...
    public String getToAccountNumber() { return toAccountNumber; }  public String getFromCardNo() { return fromCardNo; } public void setFromCardNo(String fromCardNo) { this.fromCardNo = fromCardNo; }
