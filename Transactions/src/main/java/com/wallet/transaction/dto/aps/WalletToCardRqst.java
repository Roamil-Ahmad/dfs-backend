...
public class WalletToCardRqst {
    ...
    public String getCard2Expiration() {
        return card2Expiration;
    }

    public void setCard2Expiration(String card2Expiration) {
        this.card2Expiration = card2Expiration;
    }
