...
| **Swagger UI** | http://localhost:8009/transactions/swagger-ui/index.html |
...
### 🔗 Dependencies
- **Calls →** ThirdParties (OTP), Push Notification
...
docker compose logs -f Transactions    # follow this service's logs
...
```
http://localhost:8009/transactions/swagger-ui/index.html
```
