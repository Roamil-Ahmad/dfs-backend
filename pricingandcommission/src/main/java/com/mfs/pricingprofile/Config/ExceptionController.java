...
import com.mfs.pricingprofile.utils.CustomDataNotFoundException;
import com.mfs.pricingprofile.utils.CustomException;
import com.mfs.pricingprofile.utils.ValidationException;
...
public class ExceptionController extends AbstractApi {
    ...
    private ResponseEntity<Response> handleValidationException(Exception ex, String exceptionName) {
        return getResponseFormat(HttpStatus.BAD_REQUEST, ex.getMessage(), null);
