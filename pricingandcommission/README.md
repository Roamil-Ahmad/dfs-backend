...
> Fee and commission calculation service.
...
| Property | Value |
|----------|-------|
| **Service** | Pricing & Commission (`PricingAndCommision`) |
| **Port** | `8007` |
| **Context-path** | `/fee` |
| **Swagger UI** | http://localhost:8007/fee/swagger-ui/index.html |
...
docker compose logs -f PricingAndCommision    # follow this service's logs
...
```
http://localhost:8007/fee/swagger-ui/index.html
```
